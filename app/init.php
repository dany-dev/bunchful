...
require_once APP_PATH . 'models/BiolinkTheme.php';
require_once APP_PATH . 'models/QrCode.php';
require_once APP_PATH . 'models/PaymentProcessor.php';
require_once APP_PATH . 'models/Teams.php';
require_once APP_PATH . 'models/TeamsMembers.php';
require_once APP_PATH . 'models/BlogPosts.php';
require_once APP_PATH . 'models/BlogPostsCategories.php';

/* Load some helpers */
require_once APP_PATH . 'helpers/Teams.php';
...
require_once APP_PATH . 'helpers/Paddle.php';
