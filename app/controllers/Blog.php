...
class Blog extends Controller {
    ...
    public function index() {
        ...
        if(isset($this->params[0]) && $this->params[0] != 'category') {
            $url = Database::clean_string($this->params[0]);
            ...
            $view = new \Altum\Views\View('blog/blog_post', (array) $this);
        ...
        /* Blog category */
            ...
            $url = Database::clean_string($this->params[1]);
            ...
            $view = new \Altum\Views\View('blog/blog_posts_category', (array) $this);
