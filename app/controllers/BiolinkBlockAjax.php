...
class BiolinkBlockAjax extends Controller {
    ...
    private function create() {
        ...
        if(isset($_POST['block_type']) && array_key_exists($_POST['block_type'], $this->biolink_blocks)) {
            ...
            $individual_blocks = ['link', 'heading', 'paragraph', 'avatar', 'socials', 'mail', 'rss_feed', 'custom_html', 'vcard', 'image', 'image_grid', 'divider', 'faq', 'discord', 'countdown', 'cta', 'external_item', 'share', 'youtube_feed', 'paypal', 'phone_collector', 'donation', 'product', 'service', 'map'];
    ...
    private function create_biolink_file($type) {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['name'] = mb_substr(trim(Database::clean_string($_POST['name'])), 0, 128);
        $_POST['poster_url'] = mb_substr(trim(Database::clean_string($_POST['poster_url'] ?? null)), 0, 2048);
    ...
    private function create_biolink_map() {
        $_POST['link_id'] = (int) $_POST['link_id'];
        $_POST['address'] = mb_substr(trim(Database::clean_string($_POST['address'])), 0, 64);
        $_POST['location_url'] = mb_substr(trim(Database::clean_string($_POST['location_url'])), 0, 2048);
    ...
    private function update_biolink_mail() {
        ...
        $_POST['email_notification'] = mb_substr(trim(Database::clean_string($_POST['email_notification'])), 0, 320);
    ...
    private function update_biolink_donation() {
        ...
        $_POST['title'] = mb_substr(trim(Database::clean_string($_POST['title'])), 0, $this->biolink_blocks['donation']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(trim(Database::clean_string($_POST['description'])), 0, $this->biolink_blocks['donation']['fields']['description']['max_length']);
        $_POST['prefilled_amount'] = (float) $_POST['prefilled_amount'];
        $_POST['minimum_amount'] = (float) $_POST['minimum_amount'];
        $_POST['currency'] = mb_substr(trim(Database::clean_string($_POST['currency'])), 0, $this->biolink_blocks['donation']['fields']['currency']['max_length']);
        $_POST['allow_custom_amount'] = (bool) isset($_POST['allow_custom_amount']);
        $_POST['allow_message'] = (bool) isset($_POST['allow_message']);
        $_POST['thank_you_title'] = mb_substr(trim(Database::clean_string($_POST['thank_you_title'])), 0, $this->biolink_blocks['donation']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(trim(Database::clean_string($_POST['thank_you_description'])), 0, $this->biolink_blocks['donation']['fields']['thank_you_description']['max_length']);
        $_POST['email_notification'] = mb_substr(trim(Database::clean_string($_POST['email_notification'])), 0, $this->biolink_blocks['donation']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(trim(Database::clean_string($_POST['webhook_url'])), 0, $this->biolink_blocks['donation']['fields']['webhook_url']['max_length']);
    ...
    private function update_biolink_product() {
        ...
        $_POST['title'] = mb_substr(trim(Database::clean_string($_POST['title'])), 0, $this->biolink_blocks['product']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(trim(Database::clean_string($_POST['description'])), 0, $this->biolink_blocks['product']['fields']['description']['max_length']);
        $_POST['price'] = (float) $_POST['price'];
        $_POST['minimum_price'] = (float) $_POST['minimum_price'];
        $_POST['currency'] = mb_substr(trim(Database::clean_string($_POST['currency'])), 0, $this->biolink_blocks['product']['fields']['currency']['max_length']);
        $_POST['allow_custom_price'] = (bool) isset($_POST['allow_custom_price']);
        $_POST['thank_you_title'] = mb_substr(trim(Database::clean_string($_POST['thank_you_title'])), 0, $this->biolink_blocks['product']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(trim(Database::clean_string($_POST['thank_you_description'])), 0, $this->biolink_blocks['product']['fields']['thank_you_description']['max_length']);
        $_POST['email_notification'] = mb_substr(trim(Database::clean_string($_POST['email_notification'])), 0, $this->biolink_blocks['product']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(trim(Database::clean_string($_POST['webhook_url'])), 0, $this->biolink_blocks['product']['fields']['webhook_url']['max_length']);
    ...
    private function update_biolink_service() {
        ...
        $_POST['title'] = mb_substr(trim(Database::clean_string($_POST['title'])), 0, $this->biolink_blocks['service']['fields']['title']['max_length']);
        $_POST['description'] = mb_substr(trim(Database::clean_string($_POST['description'])), 0, $this->biolink_blocks['service']['fields']['description']['max_length']);
        $_POST['price'] = (float) $_POST['price'];
        $_POST['currency'] = mb_substr(trim(Database::clean_string($_POST['currency'])), 0, $this->biolink_blocks['service']['fields']['currency']['max_length']);
        $_POST['thank_you_title'] = mb_substr(trim(Database::clean_string($_POST['thank_you_title'])), 0, $this->biolink_blocks['service']['fields']['thank_you_title']['max_length']);
        $_POST['thank_you_description'] = mb_substr(trim(Database::clean_string($_POST['thank_you_description'])), 0, $this->biolink_blocks['service']['fields']['thank_you_description']['max_length']);
        $_POST['email_notification'] = mb_substr(trim(Database::clean_string($_POST['email_notification'])), 0, $this->biolink_blocks['service']['fields']['email_notification']['max_length']);
        $_POST['webhook_url'] = mb_substr(trim(Database::clean_string($_POST['webhook_url'])), 0, $this->biolink_blocks['service']['fields']['webhook_url']['max_length']);
    ...
    public function handle_file_upload($already_existing_file, $file_name, $file_name_remove, $allowed_extensions, $upload_folder, $size_limit) {
        ...
        if($file) {
            ...
            /* Local uploading */
                ...
                /* Upload the original */
                move_uploaded_file($file_temp, UPLOADS_PATH . $upload_folder . $image_new_name);
            }
