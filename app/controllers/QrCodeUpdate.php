...
class QrCodeUpdate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            switch($_POST['type']) {
                case 'text':
                    ...
                    $settings['text'] = $_POST['text'] = mb_substr(trim(filter_var($_POST['text'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['text']['max_length']);
                    break;

                case 'url':
                    $required_fields[] = 'url';
                    $settings['url'] = $_POST['url'] = mb_substr(trim(filter_var($_POST['url'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['url']['max_length']);
                    break;

                case 'phone':
                    $required_fields[] = 'phone';
                    $settings['phone'] = $_POST['phone'] = mb_substr(trim(filter_var($_POST['phone'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['phone']['max_length']);
                    break;

                case 'sms':
                    $required_fields[] = 'sms';
                    $settings['sms'] = $_POST['sms'] = mb_substr(trim(filter_var($_POST['sms'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['sms']['max_length']);
                    $settings['sms_body'] = $_POST['sms_body'] = mb_substr(trim(filter_var($_POST['sms_body'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['sms']['body']['max_length']);
                    break;

                case 'email':
                    $required_fields[] = 'email';
                    $settings['email'] = $_POST['email'] = mb_substr(trim(filter_var($_POST['email'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['email']['max_length']);
                    $settings['email_subject'] = $_POST['email_subject'] = mb_substr(trim(filter_var($_POST['email_subject'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['email']['subject']['max_length']);
                    $settings['email_body'] = $_POST['email_body'] = mb_substr(trim(filter_var($_POST['email_body'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['email']['body']['max_length']);
                    break;

                case 'whatsapp':
                    $required_fields[] = 'whatsapp';
                    $settings['whatsapp'] = $_POST['whatsapp'] = mb_substr(trim(filter_var($_POST['whatsapp'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['whatsapp']['max_length']);
                    $settings['whatsapp_body'] = $_POST['whatsapp_body'] = mb_substr(trim(filter_var($_POST['whatsapp_body'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['whatsapp']['body']['max_length']);
                    break;

                case 'facetime':
                    $required_fields[] = 'facetime';
                    $settings['facetime'] = $_POST['facetime'] = mb_substr(trim(filter_var($_POST['facetime'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['facetime']['max_length']);
                    break;

                case 'location':
                    $required_fields[] = 'location_latitude';
                    $required_fields[] = 'location_longitude';
                    $settings['location_latitude'] = $_POST['location_latitude'] = (float) mb_substr(trim(filter_var($_POST['location_latitude'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['location']['latitude']['max_length']);
                    $settings['location_longitude'] = $_POST['location_longitude'] = (float) mb_substr(trim(filter_var($_POST['location_longitude'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['location']['longitude']['max_length']);
                    break;

                case 'wifi':
                    $required_fields[] = 'wifi_ssid';
                    $settings['wifi_ssid'] = $_POST['wifi_ssid'] = mb_substr(trim(filter_var($_POST['wifi_ssid'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['wifi']['ssid']['max_length']);
                    ...
                    $settings['wifi_password'] = $_POST['wifi_password'] = mb_substr(trim(filter_var($_POST['wifi_password'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['wifi']['password']['max_length']);
                    $settings['wifi_is_hidden'] = $_POST['wifi_is_hidden'] = (int) $_POST['wifi_is_hidden'];
                    break;

                case 'event':
                    $required_fields[] = 'event';
                    $settings['event'] = $_POST['event'] = mb_substr(trim(filter_var($_POST['event'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['event']['max_length']);
                    $settings['event_location'] = $_POST['event_location'] = mb_substr(trim(filter_var($_POST['event_location'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['event']['location']['max_length']);
                    $settings['event_url'] = $_POST['event_url'] = mb_substr(trim(filter_var($_POST['event_url'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['event']['url']['max_length']);
                    $settings['event_note'] = $_POST['event_note'] = mb_substr(trim(filter_var($_POST['event_note'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['event']['note']['max_length']);
                ...
                case 'crypto':
                    ...
                    $settings['crypto_address'] = $_POST['crypto_address'] = mb_substr(trim(filter_var($_POST['crypto_address'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['crypto']['address']['max_length']);
                    $settings['crypto_amount'] = $_POST['crypto_amount'] = isset($_POST['crypto_amount']) ? (float) $_POST['crypto_amount'] : null;
                    break;

                case 'vcard':
                    $settings['vcard_first_name'] = $_POST['vcard_first_name'] = mb_substr(trim(filter_var($_POST['vcard_first_name'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['first_name']['max_length']);
                    $settings['vcard_last_name'] = $_POST['vcard_last_name'] = mb_substr(trim(filter_var($_POST['vcard_last_name'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['last_name']['max_length']);
                    $settings['vcard_phone'] = $_POST['vcard_phone'] = mb_substr(trim(filter_var($_POST['vcard_phone'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['phone']['max_length']);
                    $settings['vcard_email'] = $_POST['vcard_email'] = mb_substr(trim(filter_var($_POST['vcard_email'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['email']['max_length']);
                    $settings['vcard_url'] = $_POST['vcard_url'] = mb_substr(trim(filter_var($_POST['vcard_url'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['url']['max_length']);
                    $settings['vcard_company'] = $_POST['vcard_company'] = mb_substr(trim(filter_var($_POST['vcard_company'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['company']['max_length']);
                    $settings['vcard_job_title'] = $_POST['vcard_job_title'] = mb_substr(trim(filter_var($_POST['vcard_job_title'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['job_title']['max_length']);
                    $settings['vcard_birthday'] = $_POST['vcard_birthday'] = mb_substr(trim(filter_var($_POST['vcard_birthday'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['birthday']['max_length']);
                    $settings['vcard_street'] = $_POST['vcard_street'] = mb_substr(trim(filter_var($_POST['vcard_street'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['street']['max_length']);
                    $settings['vcard_city'] = $_POST['vcard_city'] = mb_substr(trim(filter_var($_POST['vcard_city'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['city']['max_length']);
                    $settings['vcard_zip'] = $_POST['vcard_zip'] = mb_substr(trim(filter_var($_POST['vcard_zip'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['zip']['max_length']);
                    $settings['vcard_region'] = $_POST['vcard_region'] = mb_substr(trim(filter_var($_POST['vcard_region'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['region']['max_length']);
                    $settings['vcard_country'] = $_POST['vcard_country'] = mb_substr(trim(filter_var($_POST['vcard_country'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['country']['max_length']);
                    $settings['vcard_note'] = $_POST['vcard_note'] = mb_substr(trim(filter_var($_POST['vcard_note'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['vcard']['note']['max_length']);
                ...
                case 'paypal':
                    ...
                    $settings['paypal_email'] = $_POST['paypal_email'] = mb_substr(trim(filter_var($_POST['paypal_email'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['paypal']['email']['max_length']);
                    $settings['paypal_title'] = $_POST['paypal_title'] = mb_substr(trim(filter_var($_POST['paypal_title'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['paypal']['title']['max_length']);
                    $settings['paypal_currency'] = $_POST['paypal_currency'] = mb_substr(trim(filter_var($_POST['paypal_currency'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['paypal']['currency']['max_length']);
                    $settings['paypal_price'] = $_POST['paypal_price'] = (float) $_POST['paypal_price'];
                    $settings['paypal_thank_you_url'] = $_POST['paypal_thank_you_url'] = mb_substr(trim(filter_var($_POST['paypal_thank_you_url'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['paypal']['thank_you_url']['max_length']);
                    $settings['paypal_cancel_url'] = $_POST['paypal_cancel_url'] = mb_substr(trim(filter_var($_POST['paypal_cancel_url'], FILTER_SANITIZE_STRING)), 0, $qr_code_settings['type']['paypal']['cancel_url']['max_length']);
                    break;
            }
        ...
        $view = new \Altum\Views\View('qr-code-update/index', (array) $this);
