...
class AdminBlogPostsCategories extends Controller {
    ...
    public function index() {
        ...
        $filters->set_default_order_by('blog_posts_category_id', settings()->main->default_order_type);
        ...
        $view = new \Altum\Views\View('admin/blog-posts-categories/index', (array) $this);
