...
class AdminDomainUpdate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['custom_index_url'] = input_clean($_POST['custom_index_url']);
            $_POST['custom_not_found_url'] = input_clean($_POST['custom_not_found_url']);
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                Alerts::add_success(sprintf(l('global.success_message.update1'), '<strong>' . e($_POST['host']) . '</strong>'));
