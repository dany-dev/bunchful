    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                Alerts::add_success(sprintf(l('global.success_message.create1'), '<strong>' . e($_POST['title']) . '</strong>'));
        ...
        /* Main View */
        $view = new \Altum\Views\View('admin/blog-posts-category-create/index', (array) $this);
