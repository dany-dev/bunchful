    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                Alerts::add_success(sprintf(l('global.success_message.update1'), '<strong>' . e($_POST['title']) . '</strong>'));
        ...
        $view = new \Altum\Views\View('admin/blog-posts-category-update/index', (array) $this);
