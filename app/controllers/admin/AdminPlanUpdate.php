    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['settings'] = [
                ...
                'products_limit' => (int) $_POST['products_limit'],
            ...
            switch($plan_id) {
                ...
                default:
                    ...
                    $_POST['monthly_d_price'] = (float) $_POST['monthly_d_price'];
                    $_POST['annual_d_price'] = (float) $_POST['annual_d_price'];
                    $_POST['lifetime_d_price'] = (float) $_POST['lifetime_d_price'];
                ...
                switch ($plan_id) {
                    ...
                    default:
                        ...
                        db()->where('plan_id', $plan_id)->update('plans', [
                            ...
                            'monthly_d_price' => $_POST['monthly_d_price'],
                            'annual_d_price' => $_POST['annual_d_price'],
                            'lifetime_d_price' => $_POST['lifetime_d_price'],
