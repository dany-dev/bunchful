    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!filter_var($_POST['user_email'], FILTER_VALIDATE_EMAIL)) {
                Alerts::add_field_error('user_email', l('team_members.error_message.invalid_email'));
            }
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                Alerts::add_success(sprintf(l('team_member_create.success_message'), '<strong>' . e($_POST['user_email']) . '</strong>'));
        ...
        $view = new \Altum\Views\View('team-member-create/index', (array) $this);
