...
var company_carousel = $(".owl-carousel");
...
// if ($("#js-contcheckbox").length > 0) {
//     $("#js-contcheckbox").change(function () {
//         if (this.checked) {
//             $('.js-montlypricing').css('display', 'none');
//             $('.js-yearlypricing').css('display', 'flex');
//             $('.afterinput').addClass('text-pp');
//             $('.beforeinput').removeClass('text-pp');
//         } else {
//             $('.js-montlypricing').css('display', 'flex');
//             $('.js-yearlypricing').css('display', 'none');
//             $('.afterinput').removeClass('text-pp');
//             $('.beforeinput').addClass('text-pp');
//         }
//     });
// }
