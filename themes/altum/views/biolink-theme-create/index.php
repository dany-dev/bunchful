...
<div class="container">
    <div class="d-flex justify-content-between mb-4">
        <h1 class="h3 mb-0 mr-1"><i class="fa fa-fw fa-xs fa-palette text-primary-900 mr-2"></i> <?= l('biolink_theme_create.header') ?></h1>
    </div>
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div id="biolink_background_type_image">
                    <div class="form-group">
                        ...
                        <input id="biolink_background_type_image" type="file" name="biolink_background_image" accept=".gif, .png, .jpg, .jpeg, .svg, .mp4" class="form-control-file altum-file-input" />
