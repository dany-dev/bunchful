    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= isset($_GET['country_code']) ? sprintf(l('link.statistics.city_name_from_country'), get_country_from_country_code($data->country_code)) : l('link.statistics.city_name') ?></h3>
