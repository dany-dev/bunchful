                    ...
                    <div class="card-body">
                        ...
                        <form name="update_biolink" action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label><i class="fa fa-fw fa-anchor fa-sm text-muted mr-1"></i> <?= l('link.settings.url') ?></label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="url" placeholder="<?= l('link.settings.url_placeholder') ?>" value="<?= $data->link->url ?>" maxlength="256" onchange="update_this_value(this, get_slug)" onkeyup="update_this_value(this, get_slug)" <?= !$this->user->plan_settings->custom_url ? 'readonly="readonly"' : null ?> <?= $this->user->plan_settings->custom_url ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?> />
                                </div>
                            ...
                            <div class="collapse" id="customization_container">
                                <div class="form-group">
                                    ...
                                    <div <?= $data->company->id ? 'data-toggle="tooltip" title="' . l('global.info_message.managed_by_company') . '"' : null ?>>
                                        <div id="biolinks_themes" class="row <?= $data->company->id ? 'container-disabled' : null ?>">
                                ...
                                <div class="form-group">
                                    <div <?= $data->company->id ? 'data-toggle="tooltip" title="' . l('global.info_message.managed_by_company') . '"' : null ?>>
                                        <div class="<?= $data->company->id ? 'container-disabled' : null ?>">
                                ...
                                <div <?= $data->company->id ? 'data-toggle="tooltip" title="' . l('global.info_message.managed_by_company') . '"' : null ?>>
                                    <div id="background_type_preset" class="row <?= $data->company->id ? 'container-disabled' : null ?>">
                                ...
                                <div <?= $this->user->plan_settings->custom_backgrounds ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->custom_backgrounds ? null : 'container-disabled' ?>">
                                        ...
                                        <div id="background_type_image" data-background-container>
                                            <div class="form-group">
                                                ...
                                                <?php endif ?>
                                                <input id="background_type_image_input" type="file" name="background" accept=".gif, .png, .jpg, .jpeg, .svg, .mp4" class="form-control-file altum-file-input" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div <?= $data->company->id ? 'data-toggle="tooltip" title="' . l('global.info_message.managed_by_company') . '"' : null ?>>
                                        <div class=" <?= $data->company->id ? 'container-disabled' : null ?>">
                                            ...
                                            <input id="favicon" type="file" name="favicon" accept=".gif, .png, .ico" class="form-control-file altum-file-input" />
                                            <small class="form-text text-muted"><?= l('link.settings.favicon_help') ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div <?= $this->user->plan_settings->removable_branding ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->removable_branding ? null : 'container-disabled' ?>">
                                        <div class="custom-control custom-switch mr-3 mb-3">
                                            <input type="checkbox" class="custom-control-input" id="display_branding" name="display_branding" <?= !$this->user->plan_settings->removable_branding ? 'disabled="disabled"' : null ?> <?= $data->link->settings->display_branding ? 'checked="checked"' : null ?>>
                                ...
                                <div <?= $this->user->plan_settings->seo ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->seo ? null : 'container-disabled' ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="seo_image" type="file" name="seo_image" accept=".gif, .png, .jpg, .jpeg" class="form-control-file altum-file-input" />
                                            <small class="form-text text-muted"><?= l('link.settings.seo_image_help') ?></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="collapse" id="protection_container">
                                ...
                                <div <?= $this->user->plan_settings->sensitive_content ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
                                    <div class="<?= $this->user->plan_settings->sensitive_content ? null : 'container-disabled' ?>">
                                        <div class="custom-control custom-switch mr-3 mb-3">
                                            <input type="checkbox" class="custom-control-input" id="sensitive_content" name="sensitive_content" <?= !$this->user->plan_settings->sensitive_content ? 'disabled="disabled"' : null ?> <?= $data->link->settings->sensitive_content ? 'checked="checked"' : null ?>>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-6 col-md-5">
                                        <div class="d-flex flex-column">
                                            <a href="#" data-toggle="collapse" data-target="#biolink_block_expanded_content_<?= $row->biolink_block_id ?>" aria-expanded="false" aria-controls="biolink_block_expanded_content_<?= $row->biolink_block_id ?>">
                                    ...
                                    <div class="col-2 col-md d-flex justify-content-end">
                                        <div class="custom-control custom-switch" data-toggle="tooltip" title="<?= l('link.biolink_blocks.is_enabled_tooltip') ?>">
                                            <input type="checkbox" class="custom-control-input" id="biolink_block_is_enabled_<?= $row->biolink_block_id ?>" data-row-id="<?= $row->biolink_block_id ?>" <?= $row->is_enabled ? 'checked="checked"' : null ?>>
                                    ...
                                    <div class="col-3 col-md d-flex justify-content-end">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item" data-toggle="collapse" data-target="#biolink_block_expanded_content_<?= $row->biolink_block_id ?>" aria-expanded="false" aria-controls="biolink_block_expanded_content_<?= $row->biolink_block_id ?>">
            ...
            success: (data) => {
                ...
                if (event.currentTarget.getAttribute('name') == 'update_biolink') {
                    ...
                    if (data.details?.image_prop) {
                        ...
                        /* Background */
                        if (data.details.background_url) {
                            event.currentTarget.querySelector('[data-background-container] img').setAttribute('src', data.details.background_url);
                            event.currentTarget.querySelector('[data-background-container] img').classList.remove('d-none');
                            event.currentTarget.querySelector('[data-background-container]').classList.remove('d-none');
                        } else {
                            event.currentTarget.querySelector('[data-background-container] img').setAttribute('src', '');
                            event.currentTarget.querySelector('[data-background-container] img').classList.add('d-none');
                            event.currentTarget.querySelector('[data-background-container]').classList.add('d-none');
                        }
