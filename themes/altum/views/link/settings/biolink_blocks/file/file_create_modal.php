            ...
            <div class="modal-body">
                <form name="create_biolink_file" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="file_file" type="file" name="file" accept="<?= implode(', ', array_map(function($value) { return '.' . $value; }, $data->biolink_blocks['file']['whitelisted_file_extensions'])) ?>" class="form-control-file altum-file-input" required="required" />
