...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'donation_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            ...
            <input type="text" id="<?= 'donation_title_' . $row->biolink_block_id ?>" name="title" class="form-control" value="<?= $row->settings->title ?? null ?>" maxlength="<?= $data->biolink_blocks['donation']['fields']['title']['max_length'] ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_description_' . $row->biolink_block_id ?>"><?= l('create_biolink_donation_modal.description') ?></label>
            <input type="text" id="<?= 'donation_description_' . $row->biolink_block_id ?>" name="description" class="form-control" value="<?= $row->settings->description ?? null ?>" maxlength="<?= $data->biolink_blocks['donation']['fields']['description']['max_length'] ?>" />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" step="0.01" id="<?= 'donation_minimum_amount_' . $row->biolink_block_id ?>" name="minimum_amount" class="form-control" value="<?= $row->settings->minimum_amount ?? null ?>" />
        </div>

        <div class="form-group">
            <label for="<?= 'donation_currency_' . $row->biolink_block_id ?>"><?= l('create_biolink_donation_modal.currency') ?></label>
            <input type="text" id="<?= 'donation_currency_' . $row->biolink_block_id ?>" name="currency" class="form-control" value="<?= $row->settings->currency ?? null ?>" maxlength="<?= $data->biolink_blocks['donation']['fields']['currency']['max_length'] ?>" />
    ...
    <div class="collapse" id="<?= 'donation_data_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" id="<?= 'donation_email_notification_' . $row->biolink_block_id ?>" name="email_notification" class="form-control" value="<?= $row->settings->email_notification ?? null ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['email_notification']['max_length'] ?>" />
        ...
        <div class="form-group">
            ...
            <input type="url" id="<?= 'donation_webhook_url_' . $row->biolink_block_id ?>" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?? null ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['webhook_url']['max_length'] ?>" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input id="<?= 'donation_image_' . $row->biolink_block_id ?>" type="file" name="image" accept=".gif, .png, .jpg, .jpeg, .svg" class="form-control-file altum-file-input" />
        </div>
