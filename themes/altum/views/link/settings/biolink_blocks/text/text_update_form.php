...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label><i class="fa fa-fw fa-heading fa-sm text-muted mr-1"></i> <?= l('create_biolink_text_modal.title') ?></label>
        <input type="text" class="form-control" name="title" value="<?= $row->settings->title ?>" />
    </div>

    <div class="form-group">
        <label><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_biolink_text_modal.description') ?></label>
    ...
    <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
        <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
            <div class="form-group">
                <label><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_text_modal.title_text_color') ?></label>
            ...
            <div class="form-group">
                <label><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_text_modal.description_text_color') ?></label>
