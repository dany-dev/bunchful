...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'product_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            ...
            <input id="<?= 'product_file_' . $row->biolink_block_id ?>" type="file" name="file" accept="<?= implode(', ', array_map(function($value) { return '.' . $value; }, $data->biolink_blocks['product']['whitelisted_file_extensions'])) ?>" class="form-control-file altum-file-input" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input id="<?= 'product_image_' . $row->biolink_block_id ?>" type="file" name="image" accept=".gif, .png, .jpg, .jpeg, .svg" class="form-control-file altum-file-input" />
        </div>
