    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('create_biolink_video_modal.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_video" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="video_file"><i class="fa fa-fw fa-video fa-sm text-muted mr-1"></i> <?= l('create_biolink_video_modal.file') ?></label>
                        <input id="video_file" type="file" name="file" accept="<?= implode(', ', array_map(function($value) { return '.' . $value; }, $data->biolink_blocks['video']['whitelisted_file_extensions'])) ?>" class="form-control-file altum-file-input" required="required" />
                        <small class="form-text text-muted"><?= l('create_biolink_video_modal.file_help') ?></small>
                    </div>

                    <div class="form-group">
                        <label for="video_poster_url"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_video_modal.poster_url') ?></label>
                        <input id="video_poster_url" type="url" name="poster_url" maxlength="2048" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label for="video_name"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
