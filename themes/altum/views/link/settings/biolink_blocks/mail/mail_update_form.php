...
<form name="update_biolink_" method="post" role="form">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'mail_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'mail_settings_container_' . $row->biolink_block_id ?>">
        <?= l('create_biolink_mail_modal.mail_header') ?>
    </button>

    <div class="collapse" id="<?= 'mail_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'mail_email_placeholder_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.email_placeholder') ?></label>
            <input id="<?= 'mail_email_placeholder_' . $row->biolink_block_id ?>" type="text" name="email_placeholder" class="form-control" value="<?= $row->settings->email_placeholder ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_name_placeholder_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.name_placeholder') ?></label>
            <input id="<?= 'mail_name_placeholder_' . $row->biolink_block_id ?>" type="text" name="name_placeholder" class="form-control" value="<?= $row->settings->name_placeholder ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_button_text_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.button_text') ?></label>
            <input id="<?= 'mail_button_text_' . $row->biolink_block_id ?>" type="text" name="button_text" class="form-control" value="<?= $row->settings->button_text ?>" maxlength="64" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_success_text_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.success_text') ?></label>
            <input id="<?= 'mail_success_text_' . $row->biolink_block_id ?>" type="text" name="success_text" class="form-control" value="<?= $row->settings->success_text ?>" maxlength="256" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_thank_you_url_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.thank_you_url') ?></label>
            <input id="<?= 'mail_thank_you_url_' . $row->biolink_block_id ?>" type="url" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?>" maxlength="2048" />
        </div>
        ...
        <div class="custom-control custom-switch mr-3 mb-3">
            ...
            >
            <label class="custom-control-label clickable" for="<?= 'mail_show_agreement_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.show_agreement') ?></label>
            <div><small class="form-text text-muted"><?= l('create_biolink_mail_modal.show_agreement_help') ?></small></div>
        </div>

        <div class="form-group">
            <label for="<?= 'mail_agreement_text_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.agreement_text') ?></label>
            <input id="<?= 'mail_agreement_text_' . $row->biolink_block_id ?>" type="text" name="agreement_text" class="form-control" value="<?= $row->settings->agreement_text ?>" maxlength="256" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_agreement_url_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.agreement_url') ?></label>
            <input id="<?= 'mail_agreement_url_' . $row->biolink_block_id ?>" type="text" name="agreement_url" class="form-control" value="<?= $row->settings->agreement_url ?>" maxlength="2048" />
        </div>
    </div>

    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'mail_data_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'mail_data_container_' . $row->biolink_block_id ?>">
        <?= l('create_biolink_block_modal.data_header') ?>
    </button>

    <div class="collapse" id="<?= 'mail_data_container_' . $row->biolink_block_id ?>">
        <div class="alert alert-info">
            <i class="fa fa-fw fa-sm fa-info-circle mr-1"></i> <?= l('create_biolink_block_modal.data_help') ?>
        </div>

        <div class="form-group">
            <label for="<?= 'mail_mailchimp_api_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.mailchimp_api') ?></label>
            <input id="<?= 'mail_mailchimp_api_' . $row->biolink_block_id ?>" type="text" name="mailchimp_api" class="form-control" value="<?= $row->settings->mailchimp_api ?>" maxlength="64" />
            <small class="form-text text-muted"><?= l('create_biolink_mail_modal.mailchimp_api_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'mail_mailchimp_api_list_' . $row->biolink_block_id ?>"><?= l('create_biolink_mail_modal.mailchimp_api_list') ?></label>
            <input id="<?= 'mail_mailchimp_api_list_' . $row->biolink_block_id ?>" type="text" name="mailchimp_api_list" class="form-control" value="<?= $row->settings->mailchimp_api_list ?>" maxlength="64" />
            <small class="form-text text-muted"><?= l('create_biolink_mail_modal.mailchimp_api_list_help') ?></small>
        </div>
        ...
        <div class="form-group">
            <label for="<?= 'mail_webhook_url_' . $row->biolink_block_id ?>"><?= l('create_biolink_block_modal.webhook_url') ?></label>
            <input id="<?= 'mail_webhook_url_' . $row->biolink_block_id ?>" type="text" name="webhook_url" class="form-control" value="<?= $row->settings->webhook_url ?>" maxlength="2048" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'mail_name_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.name') ?></label>
            <input id="<?= 'mail_name_' . $row->biolink_block_id ?>" type="text" name="name" class="form-control" value="<?= $row->settings->name ?>" maxlength="128" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_image_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.image') ?></label>
            ...
            <input id="<?= 'mail_image_' . $row->biolink_block_id ?>" type="file" name="image" accept=".gif, .png, .jpg, .jpeg, .svg" class="form-control-file altum-file-input" />
        </div>

        <div class="form-group">
            <label for="<?= 'mail_icon_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.icon') ?></label>
            <input id="<?= 'mail_icon_' . $row->biolink_block_id ?>" type="text" name="icon" class="form-control" value="<?= $row->settings->icon ?>" placeholder="<?= l('create_biolink_link_modal.input.icon_placeholder') ?>" />
        ...
        <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
            <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
                <div class="form-group">
                    <label for="<?= 'mail_text_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.text_color') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_background_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.background_color') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_border_width_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-style fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_width') ?></label>
                    <input id="<?= 'mail_border_width_' . $row->biolink_block_id ?>" type="range" min="0" max="5" class="form-control" name="border_width" value="<?= $row->settings->border_width ?>" required="required" />
                </div>

                <div class="form-group">
                    <label for="<?= 'mail_border_color_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_color') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_border_radius_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-all fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_radius') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_border_style_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-border-none fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.border_style') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_animation_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.animation') ?></label>
                ...
                <div class="form-group">
                    <label for="<?= 'mail_animation_runs_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.animation_runs') ?></label>
