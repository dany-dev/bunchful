...
<div class="container">
    ...
    <p class="small text-muted">
        <span><?= sprintf(l('page.datetime'), \Altum\Date::get($data->page->datetime, 2)) ?></span> |
    ...
    <div class="mt-4">
        <small class="text-muted"><?= sprintf(l('page.last_datetime'), \Altum\Date::get($data->page->last_datetime, 2)) ?></small>
    </div>
