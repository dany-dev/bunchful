...
<ul class="list-style-none m-0">
    ...
    <li class="d-flex align-items-baseline mb-2">
        <i class="fa fa-fw fa-sm mr-3 <?= $data->plan_settings->products_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        <div class="<?= $data->plan_settings->products_limit ? null : 'text-muted' ?>">
            <?= sprintf(l('global.plan_settings.products_limit'), ($data->plan_settings->products_limit == -1 ? l('global.unlimited') : nr($data->plan_settings->products_limit))) ?>
        </div>
    </li>
