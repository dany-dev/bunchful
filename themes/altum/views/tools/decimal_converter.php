...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.decimal_converter.name') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="content"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('tools.decimal_converter.content') ?></label>
                ...
                <div class="form-group">
                    <label for="type"><i class="fa fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('tools.decimal_converter.type') ?></label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            <label for="result"><?= l($_POST['type'] == 'to_decimal' ? 'tools.decimal_converter.result.decimal' : 'tools.decimal_converter.result.text') ?></label>
                            <div>
                                <button
                                        type="button"
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.decimal_converter.extra_content') ?>
            </div>
        </div>
    </div>
</div>
