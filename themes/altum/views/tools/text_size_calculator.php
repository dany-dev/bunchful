...
<div class="container">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="text"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('tools.text_size_calculator.text') ?></label>
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.text_size_calculator.extra_content') ?>
            </div>
        </div>
    </div>
</div>
