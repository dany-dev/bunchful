...
<div class="container">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="fahrenheit" name="fahrenheit" class="form-control <?= \Altum\Alerts::has_field_errors('fahrenheit') ? 'is-invalid' : null ?>" value="<?= $data->values['fahrenheit'] ?>" required="required" />
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.fahrenheit_to_celsius.extra_content') ?>
            </div>
        </div>
    </div>
</div>
