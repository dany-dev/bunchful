...
<div class="container">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('tools.url_redirect_checker.url') ?></label>
            ...
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?= l('tools.url_redirect_checker.url') ?></th>
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.url_redirect_checker.extra_content') ?>
            </div>
        </div>
    </div>
</div>
