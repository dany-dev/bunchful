...
<div class="container">
    ...
    <div class="mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a
                                                href="<?= url('tools/download?url=' . urlencode($data->result[$key]) . '&name=' . urlencode($key . '.jpg') . '&global_token=' . \Altum\Middlewares\Csrf::get('global_token')) ?>"
                                                target="_blank"
        ...
        <div class="mt-4">
            <div class="card">
                <div class="card-body">
                    <?= l('tools.youtube_thumbnail_downloader.extra_content') ?>
                </div>
            </div>
        </div>
    </div>
