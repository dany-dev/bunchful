...
<div class="container">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="image"><i class="fa fa-fw fa-sm fa-image text-muted mr-1"></i> <?= l('tools.image_optimizer.image') ?></label>
                    ...
                    <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), '.gif, .png, .jpg, .jpeg, .webp') ?></small>
                </div>

                <div class="form-group">
                    <label for="quality"><i class="fa fa-fw fa-sort-numeric-up fa-sm text-muted mr-1"></i> <?= l('tools.image_optimizer.quality') ?></label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            <label for="result"><?= l('tools.image_optimizer.result') ?></label>
                            <div>
                                <a
                                        href="<?= url('tools/download?url=' . urlencode($data->result['file_url']) . '&name=' . urlencode($data->result['name']) . '&global_token=' . \Altum\Middlewares\Csrf::get('global_token')) ?>"
                                        target="_blank"
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.image_optimizer.extra_content') ?>
            </div>
        </div>
    </div>
</div>
