...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.celsius_to_fahrenheit.name') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="celsius"><i class="fa fa-fw fa-temperature-low fa-sm text-muted mr-1"></i> <?= l('tools.celsius_to_fahrenheit.celsius') ?></label>
                    <input type="number" id="celsius" name="celsius" class="form-control <?= \Altum\Alerts::has_field_errors('celsius') ? 'is-invalid' : null ?>" value="<?= $data->values['celsius'] ?>" required="required" />
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.celsius_to_fahrenheit.extra_content') ?>
            </div>
        </div>
    </div>
</div>
