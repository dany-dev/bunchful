...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.safe_url_checker.name') ?></h1>
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('tools.safe_url_checker.url') ?></label>
                ...
                <table class="table table-custom">
                    ...
                    <tr>
                        <td class="font-weight-bold">
                            <?= l('tools.safe_url_checker.result') ?>
                        </td>
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.safe_url_checker.extra_content') ?>
            </div>
        </div>
    </div>
</div>
