...
<div class="container">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="phone"><i class="fa fa-fw fa-phone fa-sm text-muted mr-1"></i> <?= l('tools.whatsapp_link_generator.phone') ?></label>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between align-items-center">
                        <label for="result"><?= l('tools.whatsapp_link_generator.result') ?></label>
                        <div>
                            <button
                                    type="button"
    ...
    <div class="mt-4">
        <div class="card">
            <div class="card-body">
                <?= l('tools.whatsapp_link_generator.extra_content') ?>
            </div>
        </div>
    </div>
</div>
