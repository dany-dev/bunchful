        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group" data-type="internal">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_resources.main.url_internal_placeholder') ?>" required="required" />
            ...
            <div class="form-group" data-type="external">
                <label for="url"><?= l('admin_resources.main.url') ?></label>
                <input id="url" type="url" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_resources.main.url_external_placeholder') ?>" required="required" />
                <?= \Altum\Alerts::output_field_error('url') ?>
            </div>
