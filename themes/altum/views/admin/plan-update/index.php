    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xl-4">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" id="monthly_d_price" name="monthly_d_price" class="form-control form-control-lg mt-2 <?= \Altum\Alerts::has_field_errors('monthly_d_price') ? 'is-invalid' : null ?>" placeholder="Original Price" value="<?= $data->plan->monthly_d_price ?>" />
                                <small class="form-text text-muted"><?= sprintf(l('admin_plans.main.price_help'), l('admin_plans.main.monthly_d_price')) ?></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="annual_d_price" name="annual_d_price" class="form-control form-control-lg mt-2 <?= \Altum\Alerts::has_field_errors('annual_d_price') ? 'is-invalid' : null ?>" placeholder="Original Price" value="<?= $data->plan->annual_d_price ?>" />
                            <small class="form-text text-muted"><?= sprintf(l('admin_plans.main.price_help'), l('admin_plans.main.annual_d_price')) ?></small>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="lifetime_d_price" name="lifetime_d_price" class="form-control form-control-lg mt-2 <?= \Altum\Alerts::has_field_errors('lifetime_d_price') ? 'is-invalid' : null ?>" placeholder="Original Price" value="<?= $data->plan->lifetime_d_price ?>" />
                            <small class="form-text text-muted"><?= sprintf(l('admin_plans.main.price_help'), l('admin_plans.main.lifetime_d_price')) ?></small>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="form-group">
                    <label for="products_limit"><?= l('admin_plans.plan.products_limit') ?></label>
                    <input type="number" id="products_limit" name="products_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->products_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>

                <div class="form-group">
                    <label for="qr_codes_limit"><?= l('admin_plans.plan.qr_codes_limit') ?></label>
                    <input type="number" id="qr_codes_limit" name="qr_codes_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->qr_codes_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group" <?= !settings()->links->files_is_enabled ? 'style="display: none"' : null ?>>
                    ...
                    <input type="number" id="files_limit" name="files_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->files_limit ?>" />
                ...
                <div class="form-group" <?= !settings()->links->vcards_is_enabled ? 'style="display: none"' : null ?>>
                    ...
                    <input type="number" id="vcards_limit" name="vcards_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->vcards_limit ?>" />
                ...
                <?php if (\Altum\Plugin::is_active('payment-blocks')) : ?>
                    <div class="form-group">
                        ...
                        <input type="number" id="payment_processors_limit" name="payment_processors_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->payment_processors_limit ?>" />
                        <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                    </div>
                <?php endif ?>
