...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 m-0"><i class="fa fa-fw fa-xs fa-bars text-primary-900 mr-2"></i> <?= l('admin_products.header') ?></h1>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_products.table.name') ?></option>
                                <option value="product_id" <?= $data->filters->search_by == 'product_id' ? 'selected="selected"' : null ?>><?= l('admin_products.table.product_id') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_products.table.name') ?></option>
                            </select>
                        </div>
        ...
        <table class="table table-custom">
            <thead>
                <tr>
                    ...
                    <th><?= l('admin_products.table.user') ?></th>
                    <th><?= l('admin_products.table.name') ?></th>
                    <th><?= l('admin_products.table.product_id') ?></th>
                    <th><?= l('admin_products.table.product_link') ?></th>
                    <th><?= l('admin_products.table.datetime') ?></th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <?= include_view(THEME_PATH . 'views/admin/products/admin_pixel_dropdown_button.php', ['id' => $row->id, 'resource_name' => $row->name]) ?>
                            </div>
                        </td>
                    </tr>
                <?php endforeach ?>
