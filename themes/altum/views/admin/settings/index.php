        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <div class="collapse <?= array_key_exists($data->method, $data->payment_processors) ? 'show' : null ?>" id="payment_processors_collapse">
                        <div>
                            <?php foreach($data->payment_processors as $key => $value): ?>
                    ...
                    <div class="collapse <?= in_array($data->method, ['facebook', 'google', 'twitter', 'discord']) ? 'show' : null ?>" id="social_logins_collapse">
                        <div>
