...
<html lang="<?= \Altum\Language::$code ?>" dir="<?= l('direction') ?>">
    <head>
        ...
        <?php foreach(['libraries/owl.carousel.min.css', 'libraries/owl.theme.default.min.css','custom.css', 'custom_dark.css', 'style.css'] as $file): ?>
    ...
    <body class="<?= l('direction') == 'rtl' ? 'rtl' : null ?> <?= \Altum\Routing\Router::$controller_settings['body_white'] ? 'bg-white' : null ?> <?= \Altum\ThemeStyle::get() == 'dark' ? 'c_darkmode' : null ?>" data-theme-style="<?= \Altum\ThemeStyle::get() ?>">
        ...
        <?php foreach(['libraries/jquery.min.js', 'libraries/popper.min.js', 'libraries/bootstrap.min.js', 'libraries/owl.carousel.js', 'custom.js', 'libraries/fontawesome-all.min.js'] as $file): ?>
