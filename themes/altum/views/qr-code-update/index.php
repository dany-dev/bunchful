                    ...
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="vcard">
                                ...
                                <input type="text" id="vcard_phone" name="vcard_phone" class="form-control <?= \Altum\Alerts::has_field_errors('vcard_phone') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->vcard_phone ?? null ?>" maxlength="<?= $data->qr_code_settings['type']['vcard']['phone']['max_length'] ?>" data-reload-qr-code />
            ...
            <div class="row mb-4 d-print-none">
                ...
                <div class="col-12 col-lg-6 mb-3 mb-lg-0 dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= UPLOADS_FULL_URL . 'qr_code/' . $data->qr_code->qr_code ?>" id="download_svg" class="dropdown-item" download="<?= get_slug($data->qr_code->name) . '.svg' ?>"><?= l('qr_codes.download_svg') ?></a>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'png', '<?= get_slug($data->qr_code->name) . '.png' ?>');"><?= l('qr_codes.download_png') ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'jpg', '<?= get_slug($data->qr_code->name) . '.jpg' ?>');"><?= l('qr_codes.download_jpg') ?></button>
                        <button type="button" class="dropdown-item" onclick="convert_svg_to_others(null, 'webp', '<?= get_slug($data->qr_code->name) . '.webp' ?>');"><?= l('qr_codes.download_webp') ?></button>
                    </div>
                </div>
            </div>
