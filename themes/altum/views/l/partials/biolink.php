        ...
        <div class="row d-flex justify-content-center text-center">
            <div class="col-md-8 link-content <?= isset($_GET['preview']) ? 'container-disabled-simple' : null ?>">
                ...
                <main id="links" class="my-3">
                    ...
                    <?php if (isset($data->biolink_theme->company->name) && $data->biolink_theme->company->name) { ?>
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-center">
                                <h3><?= $data->biolink_theme->company->name ?></h3>
                            </div>
                        </div>
                    <?php } ?>
                    <?php if (isset($data->biolink_theme->company_logo) && $data->biolink_theme->company_logo) { ?>
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-center">
                                <img src="<?= UPLOADS_URL_PATH.'biolinks_themes/'.$data->biolink_theme->company_logo ?>" style="max-height: 100px; max-width: 300px; object-fit: cover;" />
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row">
