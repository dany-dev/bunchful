...
<html lang="<?= \Altum\Language::$code ?>" class="link-html" dir="<?= l('direction') ?>">
    <head>
        ...
        if($this->link->settings->seo->block ?? null || \Altum\Routing\Router::$original_request == 'l/link'): ?>
        ...
        <?php foreach(['bootstrap.min.css', 'custom.css', 'link-custom.css', 'animate.min.css', 'style.css'] as $file): ?>
